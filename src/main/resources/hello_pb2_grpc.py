...
class HelloWorldServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.sendData = channel.unary_unary(
                '/HelloWorldService/sendData',
                request_serializer=hello__pb2.DataRecord.SerializeToString,
...
def add_HelloWorldServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'sendData': grpc.unary_unary_rpc_method_handler(
                    servicer.sendData,
                    request_deserializer=hello__pb2.DataRecord.FromString,
...
class HelloWorldService(object):
    ...
    def sendData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/HelloWorldService/sendData',
            hello__pb2.DataRecord.SerializeToString,

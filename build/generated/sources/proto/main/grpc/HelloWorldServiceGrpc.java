...
public final class HelloWorldServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Hello.DataRecord,
      Hello.DataResponse> getSendDataMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendData",
      requestType = Hello.DataRecord.class,
      responseType = Hello.DataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Hello.DataRecord,
      Hello.DataResponse> getSendDataMethod() {
    io.grpc.MethodDescriptor<Hello.DataRecord, Hello.DataResponse> getSendDataMethod;
    if ((getSendDataMethod = HelloWorldServiceGrpc.getSendDataMethod) == null) {
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getSendDataMethod = HelloWorldServiceGrpc.getSendDataMethod) == null) {
          HelloWorldServiceGrpc.getSendDataMethod = getSendDataMethod =
              io.grpc.MethodDescriptor.<Hello.DataRecord, Hello.DataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sendData"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Hello.DataRecord.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Hello.DataResponse.getDefaultInstance()))
              .setSchemaDescriptor(new HelloWorldServiceMethodDescriptorSupplier("sendData"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sendData(Hello.DataRecord request,
        io.grpc.stub.StreamObserver<Hello.DataResponse> responseObserver) {
  ...
  public static final class HelloWorldServiceStub
    ...
    /**
     */
    public void sendData(Hello.DataRecord request,
        io.grpc.stub.StreamObserver<Hello.DataResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class HelloWorldServiceBlockingV2Stub
    ...
    /**
     */
    public Hello.DataResponse sendData(Hello.DataRecord request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class HelloWorldServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Hello.DataResponse> sendData(
        Hello.DataRecord request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_SEND_DATA:
          serviceImpl.sendData((Hello.DataRecord) request,
              (io.grpc.stub.StreamObserver<Hello.DataResponse>) responseObserver);
          break;
        default:
